		...
		<section class='bg-white dark:bg-gray-900'>
			<div class='grid max-w-screen-xl px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12'>
				<div class='mr-auto place-self-center lg:col-span-7'>
					<h1 class='bg-clip-text max-w-2xl mb-4 text-4xl text-color-secondary font-extrabold tracking-tight leading-none md:text-5xl xl:text-6xl dark:text-white'>Laravel Live Jaipur</h1>
					...
					<a
						href='#'
						class='inline-flex items-center justify-center px-5 py-3 mr-3 text-base font-medium text-center text-white rounded-lg bg-color-secondary hover:bg-color-secondary focus:ring-4 focus:ring-primary-300 dark:focus:ring-primary-900'
					>
